...
_sym_db.RegisterEnumDescriptor(_LOCATIONMESSAGE_STATUS)
...
_LOCATIONMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='LocationMessage.status', index=4,
...
_LOCATIONMESSAGE.fields_by_name['status'].enum_type = _LOCATIONMESSAGE_STATUS
_LOCATIONMESSAGE_STATUS.containing_type = _LOCATIONMESSAGE
